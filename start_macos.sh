...
MINICONDA_DOWNLOAD_URL="https://repo.anaconda.com/miniconda/Miniconda3-py311_24.3.0-0-MacOSX-${OS_ARCH}.sh"
conda_exists="F"
...
if [ ! -e "$INSTALL_ENV_DIR" ]; then
    CONDA_SUBDIR=osx-arm64 "$CONDA_ROOT_PREFIX/bin/conda" create -y -k --prefix "$INSTALL_ENV_DIR" python=3.11 -c conda-forge
fi
